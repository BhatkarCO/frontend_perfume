          ...
          >
            ...
            <div className="flex items-center justify-between p-6 border-b border-luxury-lightgrey">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-sm font-bold font-playfair tracking-widest text-luxury-black uppercase">
                  Shopping Bag
                </h3>
              </div>
              <button
              ...
              {activeTab === "cart" ? (
                cartItems.length === 0 ? (
                  <div className="flex-1 flex flex-col items-center justify-center text-center gap-4 text-gray-400 py-12">
                    ...
                    <p className="font-playfair text-base text-luxury-black font-bold uppercase tracking-wider">
                      Your bag is empty
                    </p>
                    ...
                    <button
                      ...
                      className="btn-gold px-6 py-2.5 text-xs rounded mt-2"
                    >
                      Shop Now
                    </button>
                  </div>
                  ...
                  cartItems.map((item) => {
                    ...
                    return (
                      <div
                        key={item.id}
                        className="flex gap-4 border-b border-luxury-lightgrey pb-4"
                      >
                        ...
                        <div className="flex-1 flex flex-col justify-between">
                          <div>
                            <div className="flex justify-between items-start">
                              <h4 className="text-xs font-bold text-luxury-black line-clamp-1 font-playfair tracking-wide">
                                {item.name}
                              </h4>
                            ...
                            <p className="text-[10px] text-gray-400 capitalize">
                              {item.gender} • {item.category_name}
                            </p>
                          </div>
                          ...
                          <div className="flex justify-between items-center mt-2">
                            ...
                            <div className="flex items-center border border-luxury-lightgrey rounded bg-white">
                              ...
                              <span className="px-2 text-xs font-semibold text-luxury-black">
                                {item.quantity}
                              </span>
                              <button
                                onClick={() =>
                ...
                <div className="flex-1 flex flex-col items-center justify-center text-center gap-4 text-gray-400 py-12">
                  ...
                  <p className="text-xs font-light">
                    Save items here to buy them later.
                  </p>
                </div>
              ) : (
                savedItems.map((item) => {
            ...
            {activeTab === "cart" && cartItems.length > 0 && (
              <div className="p-6 border-t border-luxury-lightgrey bg-white flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-2 text-xs text-gray-500">
                  ...
                  <div className="flex justify-between">
                    <span>Shipping</span>
                    <span className="text-luxury-black font-semibold text-[10px] uppercase">
                  ...
                  <div className="flex justify-between font-bold text-luxury-black text-sm">
                    ...
                    <span className="font-sans">₹{grandTotal.toFixed(2)}</span>
                  </div>
                </div>
